...
WORKSPACE_SECTIONS: list[tuple[str, list[WorkspaceLink]]] = [
	(
		...
		[
			...
			("Page", "education-graduation-desk", "Graduation Desk"),
			("Page", "education-alumni-desk", "Alumni Desk"),
			("Page", "education-qa-desk", "QA & Accreditation Desk"),
	...
	(
		...
		[
			...
			("Page", "education-graduation-desk", "Graduation Desk"),
			("Page", "education-alumni-desk", "Alumni Desk"),
			("Page", "education-qa-desk", "QA Desk"),
		],
	),
	(
